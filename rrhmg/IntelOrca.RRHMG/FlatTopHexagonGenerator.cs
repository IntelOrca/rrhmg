...
{
    class FlatTopHexagonGenerator : HexagonGenerator
    {
        /// <summary>
        ...
        private readonly static Point[] InnerOffsetsArray = new [] {
            new Point(-1.0/8.0, -1.0/4.0), new Point(+1.0/8.0, -1.0/4.0),
            new Point(-1.0/4.0,      0.0), new Point(+1.0/4.0,      0.0),
            new Point(-1.0/8.0, +1.0/4.0), new Point(+1.0/8.0, +1.0/4.0)
        };

        public FlatTopHexagonGenerator(World world)
            : base(world)
        {
        }
        ...
        {
            get { return HexagonShape.FlatTop; }
        }
